              ...
              <div className="bg-white rounded-lg shadow p-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div>
                    ...
                    <div className="font-medium">{whoopData.profile.first_name} {whoopData.profile.last_name}</div>
                  </div>
                  <div>
                    <div className="text-sm text-gray-500">Email</div>
                    <div className="font-medium">{whoopData.profile.email}</div>
                  </div>
                  <div>
                    <div className="text-sm text-gray-500">User ID</div>
                    <div className="font-medium">{whoopData.profile.user_id}</div>
                  </div>
                </div>
              </div>
            )}
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <div className="font-medium">
                      {whoopData.measurements.height_meter ? 
                        `${(whoopData.measurements.height_meter * 100).toFixed(0)} cm` : 
                        'Not set'
                      }
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="font-medium">
                      {whoopData.measurements.weight_kilogram ? 
                        `${whoopData.measurements.weight_kilogram.toFixed(1)} kg` : 
                        'Not set'
                      }
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="font-medium">
                      {whoopData.measurements.max_heart_rate || 'Not set'} bpm
                    </div>
                  </div>
                </div>
              </div>
